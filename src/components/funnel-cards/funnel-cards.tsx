...
export class FunnelCards {
  ...
  componentDidLoad() {
    ...
    anchors.forEach(item=>{
      (item as HTMLElement).style.backgroundColor=(this.getContent().cardBgColor?this.getContent().cardBgColor:'var(--elham-global-theme-primary)');
  ...
  render() {
    return (
      ...
      <div class="FunnelCards font-Black">
